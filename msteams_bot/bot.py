...
CREDS = {'email' : 'navaneeth.18mis7042@vitap.ac.in','passwd':',,]Za?.r8tw6%R{'}
...
def add_timetable():
	...
	while(op==1):
		...
		#c.execute("UPDATE timetable SET name ='631_CHY1001_ES1+ES2' where name = 'CHY1001 Environmental Studies'")
...
def start_browser():
	...
	global driver
	driver = webdriver.Chrome(options=opt,executable_path="C:\DRIVERS\chromedriver_win32\chromedriver.exe")
