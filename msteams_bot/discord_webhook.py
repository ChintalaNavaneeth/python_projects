...
webhook_url = "https://discord.com/api/webhooks/835166039339171892/HUFRPnDPepIBiCjjTbByX5G-rHnW28Eqge0BdC68ckKQOVzylsLVTMbuIMEeqARsl_S0"
...
def send_msg(class_name,status,start_time,end_time):
    ...
    # Attaches a footer
    webhook.set_footer(text='-- Chintala Navaneeth --')

    if(status=="joined"):

      webhook.set_content(title='Class Joined Succesfully',
                          description="Here's your report with :smile:")
